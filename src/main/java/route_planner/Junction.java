...
public class Junction implements graphs.Identifiable
// zTODO extend superclass and/or implement interfaces

{
    ...
    public void svgDraw(PrintStream svgWriter, String colour) {
        ...
        // accounts for the reversed y-direction of the svg coordinate system relative
        // to RD-coordinates
        svgWriter.printf(Locale.ENGLISH, "<circle cx='%.3f' cy='%.3f' r='%.3f' fill='%s'/>\n",
                locationX, -locationY, radius, colour);
        svgWriter.printf(Locale.ENGLISH,
                "<text x='%.3f' y='%.3f' font-size='%d' fill='%s' text-anchor='middle'>%s</text>\n",
     ...
     * If no colour is provided, a default will be calculated on the basis of the
     * maxSpeed
     *
     * @param svgWriter
     * @param colour
    ...
    public void svgDrawRoad(PrintStream svgWriter, Junction from, double width, String colour) {
        ...
        // from RD-coordinates
        svgWriter.printf(Locale.ENGLISH,
                "<line x1='%.3f' y1='%.3f' x2='%.3f' y2='%.3f' stroke-width='%.3f' stroke='%s'/>\n",
    ...
    double getDistance(Junction target) {
        ...
        // using the locationX and locationY as provided in the dutch RD-coordinate
        // system
