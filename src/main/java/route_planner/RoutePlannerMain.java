...
public class RoutePlannerMain {
        ...
        public static void main(String[] args) {
                ...
                // TODO change the roadMap such that max average speed from Diemen to Weesp is
                // only 5 km/h

                roadMap.getEdge("Diemen", "Weesp").setMaxSpeed(5);
                roadMap.getEdge("Weesp", "Diemen").setMaxSpeed(5);

                // find the fastest route avoiding the accident
                RoadMap.DGPath path = roadMap.dijkstraShortestPath(FROM_ID, TO_ID,
                                // TODO provide an edgeWeightCalculator that yields the expected travel time for
                                // the road

                                edge -> edge.getLength() / edge.getMaxSpeed());
        ...
        private static void doPathSearches(RoadMap roadMap, String fromId, String toId) {
                ...
                path = roadMap.dijkstraShortestPath(fromId, toId,
                                // TODO provide an edgeWeightCalculator that yields the travel distance for the
                                // road
